...
**Gamma Spec Theory, Modeling, and PCB Design**
*Article for Hardware Thrashers of X*
...
The peak detector circuit, aka the "sample and hold" circuit, is a circuit which samples a signal and outputs the peak value until reset. It is important that the value of the capacitor used to hold the peak value is sized correctly to avoid undershooting the peak. This output will be sampled by the analog-to-digital converter to determine particle energy.
...
My board's design files will be on my GitHub (@eigenlucy) once V2 is ready. In the meantime, the [Open Gamma Detector](https://github.com/OpenGammaProject/Open-Gamma-Detector) project is an excellent all-in-one alternative and major inspiration for this project. You can also build the amplifier, discriminator, and peak detector on protoboard (it's much more forgiving than it looks).
...
- [Open Gamma Detector](https://github.com/OpenGammaProject/Open-Gamma-Detector) — Open source all-in-one gamma spectrometer by NuclearPhoenix
- [Gamma MCA](https://github.com/OpenGammaProject/Gamma-MCA) — Web-based multichannel analyzer for spectrum plotting
- [onsemi AND9770/D](https://www.onsemi.com/pub/collateral/and9770-d.pdf) — Introduction to the Silicon Photomultiplier
- [Villa et al., "SPICE Electrical Models and Simulations of Silicon Photomultipliers"](https://doi.org/10.1109/TNS.2015.2477716) — IEEE Trans. Nucl. Sci., vol. 62, 2015
