...
author: "Lucy M."
date: 2025-01-24
description: "Notes on Walter Benjamin's Critique of Violence and the Theses on the Concept of History"
...
These were my notes from around when I first moved to SF in the aftermath of the hurricane et al (see [Origin is the Goal](/eigenlucy/origin/)). These are basically the points I've been slowly elaborating over the course of my recent essays ([War Communism](/eigenlucy/warcommunism/), [Kaddish](/eigenlucy/kaddish/), [Iemanja](/eigenlucy/iemanja/), [Multiplicity](/eigenlucy/multiplicity/), and [Le Fin de Satan](/eigenlucy/bastille/)). I still have some points to clarify: transition as standstill, as the grace and faith which doesn't need any recourse to a restored whole nor an idealistic emergentism, a faith that can hold immanence and transcendence at once. "That magical formula we seek: pluralism = monism." These are the stakes of repairing a foreclosed life.
